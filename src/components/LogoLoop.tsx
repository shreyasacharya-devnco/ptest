...
export const LogoLoop = React.memo<LogoLoopProps>(
  ({
        ...
        const content = isNodeItem ? (
          <span
            className={cx(
              ...
              scaleOnHover &&
                // scale-[1.2] — arbitrary value; scale-120 is not in the default Tailwind token set
    ...
    return (
      // Outer wrapper is stationary — hover detection here is reliable regardless
      // of whether the inner track is GPU-composited and moving.
      <div
        className="relative"
