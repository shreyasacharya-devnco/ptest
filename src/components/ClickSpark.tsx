...
const ClickSpark: React.FC<ClickSparkProps> = ({
  ...
  // Canvas is fixed to the viewport — resize to window dimensions
  useEffect(() => {
  ...
  const handleClick = (e: React.MouseEvent<HTMLDivElement>) => {
    // Coordinates are already viewport-relative — matches the fixed canvas
    const x = e.clientX;
    const y = e.clientY;
  ...
  return (
    <div className="relative w-full" onClick={handleClick}>
      {/* Canvas is fixed so it covers the full viewport regardless of scroll */}
      <canvas
        ref={canvasRef}
